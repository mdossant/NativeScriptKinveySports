...
var jsdo_core_1 = require("./progress.core");
            ...
            _this.jsdo.invoke(name, object)
                ...
                try {
                    if (typeof (result.request.response) === "object"
                        ...
                        /*countVal = Object.values(result.request.response)[0];*/ //ES2017 and brittle!
						countVal = result.request.response["" + Object.keys(result.request.response)[0]];
